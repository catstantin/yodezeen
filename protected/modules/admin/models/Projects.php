...
class Projects extends CActiveRecord 
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('status, location, body, type, best', 'safe'),
    ...
    public function attributeLabels()
    {
        return array(
            ...
            'body' => Yii::t('adminModule.app','Описание'),
            'img' => Yii::t('adminModule.app','Главное изображение'),
            'location' => Yii::t('adminModule.app','Местоположение'),
    ...
    {
        return Yii::app()->db->tablePrefix.'projects';
    }
