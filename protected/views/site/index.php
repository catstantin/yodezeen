...
<div id="fullpage">
		...
		<div class="slide"  data-anchor="splash" id="splash-slide">
			<div id="trailer" class="is_overlay">
				<video id="video" width="100%" height="auto" autoplay="autoplay" loop="loop" preload="auto">
					<source src="video/mainpage.m4v" type="video/mp4" />
					<source src="video/mainpage.webm" type="video/webm" />
					<source src="video/mainpage.ogv"></source>
	...
	<div class="section" id="page2">
		...
		<div class="slide" data-anchor="projects" id="projects">
			...
			<p class="text-ab shad our">&Oslash;UR &Oslash;BJECTS</p>
	...
	<div class="section best" id="page3">
		<div class="all-works"><a href="/#page-1/portfolio">All projects</a></div>
	...
	<!-- Страница 4 -->
	<div class="section" data-anchor="page-4" id="page4">
